  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.mainDetails}>
        ...
        <div className={styles.detailText}>
          <span className={styles.title}>Register For The Semester</span>
          <p className={styles.titleValue}>{data["registeredSemester"]}</p>
        </div>
        <div className={styles.detailText}>
          <span className={styles.title}>Course Form Submitted</span>
          <p className={styles.titleValue}>{data["submittedCourseForm"]}</p>
        </div>
      </div>
    </div>
  )
