  ...
  return (
    <div className={styles.modalContainer}>
      <div className={styles.modalContent}>
        ...
        {
          showSuccess ? <p className={styles.secondText}>Student status has been updated <br/> successfully</p> 
          : <p className={styles.secondText}>Are you sure you want to {props.btnText}<br/> this student ?</p> 
        }
