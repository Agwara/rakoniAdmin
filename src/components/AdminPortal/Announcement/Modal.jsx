  ...
  return (
    <div className={styles.modalContainer}>
      <div className={styles.modalContent}>
        ...
        {
          showSuccess ? <p className={styles.secondText}>Student announcement has been sent <br/> successfully</p> 
          : <p className={styles.secondText}>Are you sure you want to send <br/> an announcement?</p> 
        }
