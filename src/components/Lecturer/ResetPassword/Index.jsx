    ...
    <div className={styles.container}>
      ...
      <div className={styles.formContainer}>
        <div className={styles.formField}>
          <TextField type="text" label="Lecturer ID" value={studentID} setValue={setStudentID} />
        </div>

        <div className={styles.formField}>
        <TextField type="email" label="Lecturer Email" value={studentEmail} setValue={setStudentEmail} />
        </div>
